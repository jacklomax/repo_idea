...
public class PromotionSpaceController {
    ...
    public ResponseResult findAllPromotionsSpace(){
    ...
    public ResponseResult findPromotionSpaceById(int id){
        PromotionSpace p = promotionSpaceService.findPromotionSpaceById(id);
        return new ResponseResult(true,200,"查询具体广告位成功",p);
    }
}
